...
function showTooltip() {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    $('#createPostArea').on('click',function() {
     ...
     $(document).ready(function() {
    	    $('.js-post-reaction.post-bottom-button').on('click', function() {
    	        $(this).toggleClass('on');
    	    });
    	});
     $(document).ready(function(){
     		 $('.js-post-bookmark.post-bottom-button').on('click',function() {
    	  		$(this).toggleClass('on');
    	});
     });
     $(document).ready(function(){
     ...
     function hideAllSearchAreas() {
   	 ...
   	 $(function () {
   		$(".recent-project-item").click(function() {
   		 const project_id = this.querySelector("span.js-mouseover.ellipsis").textContent;
   		$("#projectTitle").text(project_id);
   	...
   	/*  $(document).on("click",".recent-project-item",function(){
   		let pro_id = $(this).attr("project_id");
   		load_proeject_page(project_id);
   	 });
   	  */
								...
								<div class="menu-accordion">
									<div class="bg-type lnb">
										<ul id="RecentProjectUl" class="menu-accordion-list">
											<li class="recent-project-item" data-project-srno="1852542"
...
<!-- 아래 메인 -->
<%
    String sql = "SELECT * FROM employees WHERE employees_id='hkbkbk'";
...
<!-- 			검색창 -->
					...
					<div class="contact-section scroll-mask thin">
						<ul class="contact-contents">
							...
							<li id="profileEml" style="display: flex" data=""><em><i
									class="profile-mail js-user-email"></i></em> <span><%=rs.getString("employees_id")%></span>
							</li>
			...
			<div class="flow-project-make-2">
				<div id="innerMySettingPopup" class="my-layer-type-3">
					...
					<div class="my-layer-content">
						...
						<%
						    String sql1 = "SELECT * FROM employees WHERE employees_id='hkbkbk'";
								...
								<div class="my-right-style adjust">
									<ul>
										...
										<li>
											...
											<div id="user_id" class="my-right-list-2"><%=rs.getString("employees_id")%></div>
										</li>
										...
										<li class="edit-input js-company-set adjust" id="settingCmnm">
											...
											<div class="read-mode d-block">
												<div id="companyName" class="my-right-list-2"><%=rs.getString("employees_id")%></div>
											</div>
										</li>
										...
										<li class="edit-input js-email-set adjust" id="settingEml"
											...
											<div class="read-mode d-block">
												<div id="email" class="my-right-list-2"><%=rs.getString("employees_id")%></div>
	...
	<div class="flow-all-background-1 js-popup-before d-none">
		<div
			class="js-popup-before edit-item create-post-wrap js-pop-contents js-editor "
			data-code="ADD">
